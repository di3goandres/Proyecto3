            ...
            <div>
                    ...
                    <tr>
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="UserNameRequired" runat="server" ControlToValidate="UserName"
                                ...
                                ToolTip="El nombre de usuario es obligatorio." ValidationGroup="LoginUserValidationGroup">* El nombre de usuario es obligatorio.</asp:RequiredFieldValidator>
                            <br />
                        </td>
                    ...
                    <tr>
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="PasswordRequired" runat="server" ControlToValidate="Password"
                                ...
                                ValidationGroup="LoginUserValidationGroup">* La contraseña es obligatoria.</asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    </table>
                <div style="margin-top:auto" class="form-group">
                 ...
                 <div style="border-top: 1px solid#888; padding-top:15px; font-size:85%" >
                            ...
                            <a class="link_cafe" href="./Registro/RegistroUsuarios.aspx">
                            Registrese 
                            </a>
                        </div> 
            </div>
